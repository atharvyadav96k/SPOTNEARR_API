package accept_claim

import (
	"errors"
	"net/http"

	"github.com/atharvyadav96k/SPOTNEARR_API/business/accept_claim/applayer"
...
func Function(w http.ResponseWriter, r *http.Request) {
	...
	if claim.Status != models.ClaimPending {
		utils.BadRequest(w, errors.New("only pending claims can be accepted"))
		return
	}
	if err := app.SetClaimStatus(body.ID, models.ClaimAccepted); err != nil {
		utils.BadRequest(w, err)
		return
	}
	utils.OK(w, "claim accepted successfully", nil)
}
